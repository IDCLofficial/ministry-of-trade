...
const teamMembers = [
  {
    name: 'Hon. Barr. Rex Anunobi',
    role: 'Hon. Commissioner',
    image: '/images/commisioner.png',
    bio: 'Provides visionary leadership and strategic direction for the Ministry of Trade, Commerce & Investment in Imo State.'
  },
  {
    name: 'Dr. Daniel John Ogacheko',
...
export default function TeamPage() {
  return (
    <section className="w-full min-h-max bg-[#f4f8f9] py-32 flex flex-col items-center">
