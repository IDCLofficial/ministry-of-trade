...
const stats = [
  { value: 500, suffix: "+", desc: "Businesses Supported" },
  { value: 75, suffix: "%", desc: "Increase in Local Trade Volume" },
  { value: 120, suffix: "M", prefix: "₦", desc: "Investment Attracted" },
  { value: 40, suffix: "+", desc: "Trade Partnerships Established" },
];
...
export default function Stats() {
  ...
  return (
    <section ref={ref} className="w-full bg-[#0A2647] p-8 py-20">
