...
export default function HeroSection({
  ...
  return (
    <section className="relative max-h-max py-10 md:py-16">
    {/* Background Image */}
    ...
    {/* Frosted Glass Card */}
    <div className="relative lg:mt-0 z-10 max-w-[96vw] lg:max-w-[50vw] px-6 md:px-10 pt-32 lg:pt-20 pb-6 lg:pb-32 md:pt-48">
